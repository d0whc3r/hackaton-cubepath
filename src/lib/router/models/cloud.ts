...
const EXPLAIN_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_MINIMAX_M21, CLOUD_GLM_47, CLOUD_GPT_OSS_120]
const DEFAULT_EXPLAIN_MODEL_CLOUD = EXPLAIN_MODELS_CLOUD[0].id

const TEST_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_GLM_47, CLOUD_MINIMAX_M21, CLOUD_GPT_OSS_120]
const DEFAULT_TEST_MODEL_CLOUD = TEST_MODELS_CLOUD[0].id

const REFACTOR_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_DEEPSEEK_V31, CLOUD_MINIMAX_M21, CLOUD_GLM_47]
const DEFAULT_REFACTOR_MODEL_CLOUD = REFACTOR_MODELS_CLOUD[0].id

const COMMIT_MODELS_CLOUD: ModelOption[] = [CLOUD_GPT_OSS_20, CLOUD_GLM_47, CLOUD_MINIMAX_M21, CLOUD_GPT_OSS_120]
const DEFAULT_COMMIT_MODEL_CLOUD = COMMIT_MODELS_CLOUD[0].id

const DOCSTRING_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_GLM_47, CLOUD_MINIMAX_M21, CLOUD_GPT_OSS_120]
const DEFAULT_DOCSTRING_MODEL_CLOUD = DOCSTRING_MODELS_CLOUD[0].id

const TYPE_HINTS_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_GLM_47, CLOUD_DEEPSEEK_V31, CLOUD_MINIMAX_M21]
const DEFAULT_TYPE_HINTS_MODEL_CLOUD = TYPE_HINTS_MODELS_CLOUD[0].id

const ERROR_EXPLAIN_MODELS_CLOUD: ModelOption[] = [CLOUD_MINIMAX_M21, CLOUD_CODER_480, CLOUD_DEEPSEEK_V31, CLOUD_GLM_47]
const DEFAULT_ERROR_EXPLAIN_MODEL_CLOUD = ERROR_EXPLAIN_MODELS_CLOUD[0].id

const PERFORMANCE_HINT_MODELS_CLOUD: ModelOption[] = [
  CLOUD_DEEPSEEK_V31,
  CLOUD_CODER_480,
  CLOUD_MINIMAX_M21,
  CLOUD_GLM_47,
]
const DEFAULT_PERFORMANCE_HINT_MODEL_CLOUD = PERFORMANCE_HINT_MODELS_CLOUD[0].id

const NAMING_HELPER_MODELS_CLOUD: ModelOption[] = [CLOUD_GPT_OSS_20, CLOUD_GLM_47, CLOUD_MINIMAX_M21, CLOUD_QWEN35]
const DEFAULT_NAMING_HELPER_MODEL_CLOUD = NAMING_HELPER_MODELS_CLOUD[0].id

const DEAD_CODE_MODELS_CLOUD: ModelOption[] = [CLOUD_CODER_480, CLOUD_DEEPSEEK_V31, CLOUD_MINIMAX_M21, CLOUD_GLM_47]
const DEFAULT_DEAD_CODE_MODEL_CLOUD = DEAD_CODE_MODELS_CLOUD[0].id
