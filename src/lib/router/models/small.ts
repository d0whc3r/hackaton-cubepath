...
const EXPLAIN_MODELS_SMALL: ModelOption[] = [
  SMALL_QWEN25_CODER_3B,
  SMALL_GRANITE_CODE_3B,
  SMALL_PHI3,
  SMALL_QWEN25_CODER_15B,
]
const DEFAULT_EXPLAIN_MODEL_SMALL = EXPLAIN_MODELS_SMALL[0].id

const TEST_MODELS_SMALL: ModelOption[] = [SMALL_QWEN25_CODER_3B, SMALL_GRANITE_CODE_3B, SMALL_QWEN25_CODER_15B]
const DEFAULT_TEST_MODEL_SMALL = TEST_MODELS_SMALL[0].id

const REFACTOR_MODELS_SMALL: ModelOption[] = [
  SMALL_QWEN25_CODER_3B,
  SMALL_PHI3,
  SMALL_GRANITE_CODE_3B,
  SMALL_QWEN25_CODER_15B,
]
const DEFAULT_REFACTOR_MODEL_SMALL = REFACTOR_MODELS_SMALL[0].id

const COMMIT_MODELS_SMALL: ModelOption[] = [
  SMALL_QWEN25_CODER_15B,
  SMALL_QWEN25_CODER_05B,
  SMALL_GRANITE33_2B,
  SMALL_QWEN25_CODER_3B,
]
const DEFAULT_COMMIT_MODEL_SMALL = COMMIT_MODELS_SMALL[0].id

const DOCSTRING_MODELS_SMALL: ModelOption[] = [SMALL_QWEN25_CODER_15B, SMALL_QWEN25_CODER_3B, SMALL_GRANITE33_2B]
const DEFAULT_DOCSTRING_MODEL_SMALL = DOCSTRING_MODELS_SMALL[0].id

const TYPE_HINTS_MODELS_SMALL: ModelOption[] = [SMALL_QWEN25_CODER_15B, SMALL_QWEN25_CODER_3B, SMALL_GRANITE_CODE_3B]
const DEFAULT_TYPE_HINTS_MODEL_SMALL = TYPE_HINTS_MODELS_SMALL[0].id

const ERROR_EXPLAIN_MODELS_SMALL: ModelOption[] = [SMALL_PHI3, SMALL_QWEN25_CODER_3B, SMALL_GRANITE33_2B]
const DEFAULT_ERROR_EXPLAIN_MODEL_SMALL = ERROR_EXPLAIN_MODELS_SMALL[0].id

const PERFORMANCE_HINT_MODELS_SMALL: ModelOption[] = [SMALL_QWEN25_CODER_3B, SMALL_PHI3, SMALL_GRANITE_CODE_3B]
const DEFAULT_PERFORMANCE_HINT_MODEL_SMALL = PERFORMANCE_HINT_MODELS_SMALL[0].id

const NAMING_HELPER_MODELS_SMALL: ModelOption[] = [SMALL_GRANITE33_2B, SMALL_QWEN25_CODER_15B, SMALL_PHI3]
const DEFAULT_NAMING_HELPER_MODEL_SMALL = NAMING_HELPER_MODELS_SMALL[0].id

const DEAD_CODE_MODELS_SMALL: ModelOption[] = [SMALL_QWEN25_CODER_3B, SMALL_GRANITE_CODE_3B, SMALL_QWEN25_CODER_15B]
const DEFAULT_DEAD_CODE_MODEL_SMALL = DEAD_CODE_MODELS_SMALL[0].id
