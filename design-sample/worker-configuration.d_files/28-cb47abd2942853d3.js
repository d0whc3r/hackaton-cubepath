  ...
  [28],
  {
    ...
    8173: (e, t, n) => {
      ...
      let y = u.default.forwardRef(function (e, t) {
        ...
        ;((n = g), M && ('string' == typeof n || 'number' == typeof n) && (n = (0, o.jsx)('a', { children: n })))
        let k = u.default.useContext(l.AppRouterContext),
          w = !1 !== b,
          I = null === b ? i.PrefetchKind.AUTO : i.PrefetchKind.FULL,
          { href: S, as: x } = u.default.useMemo(() => {
            let e = h(a)
            return { href: e, as: y ? h(y) : e }
          }, [a, y]),
          R = u.default.useRef(S),
          T = u.default.useRef(x)
        M && (r = u.default.Children.only(n))
        let N = M ? r && 'object' == typeof r && r.ref : t,
          [A, U, F] = (0, f.useIntersection)({ rootMargin: '200px' }),
          L = u.default.useCallback(
            (e) => {
              ;((T.current !== x || R.current !== S) && (F(), (T.current = x), (R.current = S)), A(e))
            },
            [x, S, F, A],
          ),
          K = (0, c.useMergedRef)(L, N)
        u.default.useEffect(() => {
          k && U && w && p(k, S, { kind: I })
        }, [x, S, U, w, k, I])
        let q = {
                ...
                (function (e, t, n, r, o, a, l) {
                  ...
                  ;('A' === f.toUpperCase() &&
                    ...
                    u.default.startTransition(() => {
                      let e = null == l || l
                      'beforePopState' in t
                        ? t[o ? 'replace' : 'push'](n, r, { shallow: a, scroll: e })
        ...
        return (
          (0, s.isAbsoluteUrl)(x)
            ? (q.href = x)
            : (M && !m && ('a' !== r.type || 'href' in r.props)) || (q.href = (0, d.addBasePath)(x)),
          M ? u.default.cloneElement(r, q) : (0, o.jsx)('a', { ...C, ...q, children: n })
        )
      })
    ...
    180: (e, t, n) => {
      ...
      function u(e) {
        ...
        ;((t = t ? encodeURIComponent(t).replace(/%3A/i, ':') + '@' : ''),
          e.host
            ? (i = t + e.host)
            : n && ((i = t + (~n.indexOf(':') ? '[' + n + ']' : n)), e.port && (i += ':' + e.port)),
          f && 'object' == typeof f && (f = String(r.urlQueryToSearchParams(f))))
        let c = e.search || (f && '?' + f) || ''
        return (
          u && !u.endsWith(':') && (u += ':'),
          ...
          l && '#' !== l[0] && (l = '#' + l),
          c && '?' !== c[0] && (c = '?' + c),
          '' + u + i + (a = a.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace('#', '%23')) + l
        )
      }
      let a = [
        'auth',
    ...
    2170: (e, t) => {
      ...
      async function s(e, t) {
        ...
        if (n && i(n)) return r
        if (!r)
          throw Error('"' + f(e) + '.getInitialProps()" should resolve to an object. But found "' + r + '" instead.')
        return r
      }
...
//# sourceMappingURL=28-cb47abd2942853d3.js.map
